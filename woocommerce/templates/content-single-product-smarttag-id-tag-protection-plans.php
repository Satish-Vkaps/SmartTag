...
if(isset($_GET['switch-subscription'])){
  ...
  //SmartTag Pet Protection Plan Parent Id 6137
      ...
      <script type="text/javascript">
        ...
        if(jQuery.trim(current_url) === '<?= site_url("/product/aluminum-id-tag/"); ?>' ||
          jQuery.trim(current_url) === '<?= site_url("/product/brass-id-tag/"); ?>')
        {
          $('#skip-plan').show();
          $("a#skip-plan").attr("href", "javascript:void(0)")  
          $(".pp-tabs-nav").hide();
          $(".pp-tabs-content.pp-tab-content-1").hide();
          $(".pp-tabs-content.pp-tab-content-2").show();
        }
        ...
        $("body").on('click','.SubPln',function(e){
          ...
          $('#pa_plan').find('option').each( function() {
           ...
           var current_url =  window.location.href;
          if(jQuery('#pa_protection').val() !="" && jQuery('#pa_plan').val() !="" && jQuery.trim(current_url) !== '<?= site_url("/product/aluminum-id-tag/"); ?>' && jQuery.trim(current_url) !== '<?= site_url("/product/brass-id-tag/"); ?>'){
            alert('ifff')
          ...
          var productid = $('#'+id).attr('productid');
           $('#skip-plan').hide();
            jQuery.ajax({
                        ...
                        url: ajaxurl,
                        data: {
                          action : 'add_protection_pant_on_single_product',
                        ...
                        success: function(response) {
                          ...
                          if(Obj.success == 1){
                             jQuery(".loader-wrap").fadeOut();
                              $('#'+id).html('Added to cart <i class="fa fa-check"></i>');
                               alert('protection plan added to cart successfully!')   
                          }  
                          else{
