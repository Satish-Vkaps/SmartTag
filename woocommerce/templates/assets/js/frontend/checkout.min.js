...
// var error = $(document).find("#shipping_state").parent().parent().find('#shipping_state-error');
	...
	var validator = jQuery('form[name="checkout"]').validate({
		errorPlacement: function(error, element) {
			  	if(element.attr("name") == "shipping_state"){
			  		if (jQuery("#shipping_state").next("lable#shipping_state-error")) {
						$tt = jQuery("#shipping_state").next("lable#shipping_state-error").clone();
						console.log($tt.html());
						jQuery("#shipping_state").next("lable#shipping_state-error").remove();
						jQuery("#shipping_state").parent().parent().find('.woocommerce-input-wrapper').after('<label id="shipping_state-error" class="error" for="shipping_state">This field is required.</label>');
					}
                ...
                if(element.attr("name") == "billing_state"){
			  		if (jQuery("#billing_state").next("lable#billing_state-error")) {
						$tt = jQuery("#billing_state").next("lable#billing_state-error").clone();
						console.log($tt.html());
						jQuery("#billing_state").next("lable#billing_state-error").remove();
						jQuery("#billing_state").parent().parent().find('.woocommerce-input-wrapper').after('<label id="billing_state-error" class="error" for="billing_state">This field is required.</label>');
					}
			  		// $("#shipping_state").parent().parent().find('.woocommerce-input-wrapper').after('<label id="shipping_state-error" class="error" for="shipping_state">This field is required.</label>');
	          	  return true;
                } 
	    		...
	    		billing_phone: {
                    ...
                    "remote":
                    {
                      ...
                      data:
                      {
                         ...
                         {
                          return jQuery('form.woocommerce-checkout input[name="billing_phone"]').val();
                         }
                      }
                    }
                },
	    		billing_email:{
                    ...
                    "remote":
                    {
                      ...
                      data:
                      {
                         ...
                         userEmail: function()
                         {
                          return jQuery('form.woocommerce-checkout input[name="billing_email"]').val();
                         }
                      }
                    }
                },
